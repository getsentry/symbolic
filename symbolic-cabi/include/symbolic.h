 ...
 */
typedef struct SymbolicSmCache SymbolicSmCache;
 ...
 */
struct SymbolicSmCache *symbolic_smcache_from_bytes(const char *source_content,
 ...
 * Free a token match.
 */
void symbolic_smcache_token_match_free(struct SymbolicSmTokenMatch *token_match);
